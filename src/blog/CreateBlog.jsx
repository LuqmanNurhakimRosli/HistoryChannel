...
const CreateBlog = () => {
  ...
  return (
    <div 
      className="flex justify-center items-center min-h-screen bg-gray-100 bg-cover bg-center px-4"
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 mt-2">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  className="hidden"
                />
                <span className={`px-4 py-2 rounded-lg text-sm font-semibold ${publishOption === 'forEveryone' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'}`}>
                  Public
                </span>
              </label>
              ...
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  className="hidden"
                />
                <span className={`px-4 py-2 rounded-lg text-sm font-semibold ${publishOption === 'forMe' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'}`}>
                  Private
                </span>
              </label>
            </div>
